...
public class AmalgamateDog extends Monster {
	//create string called file1 initialized as amalgam dog
	static String file1="./Sprites/spr_amalgam_dognpc_0.png";
	//create string called file2 initialized as amalgam dog
	static String file2="./Sprites/spr_amalgam_dognpc_1.png";
	...
	//constructor
	public AmalgamateDog(int posx,int posy,double size,int speed) {
