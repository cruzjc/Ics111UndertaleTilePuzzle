...
public class SnowDrakesMom extends Monster{

	//create string called file1 initialized as amalgam
	static String file1="./Sprites/spr_snowdrakesmom_0.png";
	//create string called file2 initialized as amalgam
	static String file2="./Sprites/spr_snowdrakesmom_1.png";
	//create string called file1 initialized as amalgam
	static String file3="./Sprites/spr_snowdrakesmom_2.png";
	//create string called file2 initialized as amalgam
	static String file4="./Sprites/spr_snowdrakesmom_3.png";
	...
	public SnowDrakesMom(int posx,int posy,double size) {
